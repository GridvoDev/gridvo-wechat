...
class Gateway {
    ...
    getPreAuthCode(suiteID, suiteAccessToken, traceContext, callback) {
        var url = `https://${WECHAT_QYAPI_SERVICE_HOST}:${WECHAT_QYAPI_SERVICE_PORT}/cgi-bin/service/get_pre_auth_code?suite_access_token=${suiteAccessToken}`;
        var options = {
            method: "POST",
            path: url,
            entity: {
    ...
    getPermanentCode(suiteID, authCode, suiteAccessToken, traceContext, callback) {
        var url = `https://${WECHAT_QYAPI_SERVICE_HOST}:${WECHAT_QYAPI_SERVICE_PORT}/cgi-bin/service/get_permanent_code?suite_access_token=${suiteAccessToken}`;
        var options = {
            method: "POST",
            path: url,
            entity: {
